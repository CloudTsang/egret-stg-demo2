window.skins=window.skins||{};
	...
	return BtnJet;
})(eui.Skin);generateEUI.paths['resource/eui_skins/BtnMissle.exml'] = window.skins.BtnMissle = (function (_super) {
	__extends(BtnMissle, _super);
	function BtnMissle() {
		_super.call(this);
		this.skinParts = [];
		...
		this.states = [
			...
			new eui.State ("down",
				[
					new eui.AddItems("_Rect2","",2,"_Group1"),
					new eui.SetProperty("","width",200),
					new eui.SetProperty("","height",200)
				])
			,
	...
	var _proto = BtnMissle.prototype;
	...
	_proto._Image1_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "sheet_json#missilelaucher";
		t.x = 0;
		t.y = 0;
		return t;
	};
	...
	function ControlPanel() {
		_super.call(this);
		this.skinParts = ["btn_shot","leftup","up","rightup","left","right","leftdown","down","rightdown","analog","hp_gauge","btn_barrier","barrier_gauge_disp","btn_missle","lock_gauge_disp"];
		
		this.height = 400;
		this.width = 800;
		this.elementsContent = [this.btn_shot_i(),this.analog_i(),this.hp_gauge_i(),this._Group5_i(),this._Group6_i()];
	}
	...
	_proto._Group5_i = function () {
		...
		t.elementsContent = [this.btn_barrier_i(),this.barrier_gauge_disp_i()];
		return t;
	};
	...
	_proto.barrier_gauge_disp_i = function () {
		var t = new eui.Rect();
		this.barrier_gauge_disp = t;
	...
	_proto._Group6_i = function () {
		...
		t.elementsContent = [this.btn_missle_i(),this.lock_gauge_disp_i()];
		return t;
	};
	...
	_proto.btn_missle_i = function () {
		var t = new eui.Button();
		this.btn_missle = t;
		t.horizontalCenter = 0;
		t.label = "Button";
		t.skinName = "skins.BtnMissle";
		t.verticalCenter = 0;
		t.x = 601.698;
		t.y = -251.423;
		return t;
	};
	_proto.lock_gauge_disp_i = function () {
		var t = new eui.Rect();
		this.lock_gauge_disp = t;
		t.ellipseHeight = 1000;
		t.ellipseWidth = 1000;
		t.fillAlpha = 0;
		t.horizontalCenter = 0;
	...
	function Description() {
		...
		this.states = [
			...
			new eui.State ("p5",
				[
					new eui.AddItems("_Group47","",2,"btn_next")
				])
		];
	}
	...
	_proto._Group47_i = function () {
		...
		t.elementsContent = [this._Group39_i(),this._Group41_i(),this._Group42_i(),this._Label21_i(),this._Group43_i(),this._Label22_i(),this._Group44_i(),this._Group46_i()];
		return t;
	};
	...
	_proto._Group41_i = function () {
		...
		t.elementsContent = [this._Image9_i(),this._Group40_i(),this._Label20_i()];
		return t;
	};
	...
	_proto._Label22_i = function () {
		...
		t.percentWidth = 90;
		t.size = 35;
		t.text = "持续追踪一架敌机并使其位于自机前方一定范围内时，导弹锁定槽会增长，满值后可发射导弹对其造成大伤害。拾取特定漂流物后可以强化锁定范围和导弹威力等数值。";
		t.wordWrap = true;
		t.x = 292;
		t.y = 498;
		return t;
	...
	_proto._Group46_i = function () {
		...
		t.elementsContent = [this._Image10_i(),this._Label23_i(),this._Group45_i()];
		return t;
	};
	...
	_proto._Group45_i = function () {
		...
		t.x = 431;
		t.y = 10;
		t.elementsContent = [this._Image11_i(),this._Label24_i()];
		return t;
	};
