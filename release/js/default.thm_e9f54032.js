window.skins=window.skins||{};
	...
	function ControlPanel() {
		_super.call(this);
		this.skinParts = ["btn_barrier","btn_shot","leftup","up","rightup","left","right","leftdown","down","rightdown","analog","barrier_gauge"];
		
		this.height = 400;
		this.width = 800;
		this.elementsContent = [this.btn_barrier_i(),this.btn_shot_i(),this.analog_i(),this.barrier_gauge_i()];
	}
	...
	_proto._Label2_i = function () {
		...
		t.percentWidth = 90;
		t.size = 45;
		t.text = "驾驶战机在3分钟内躲避或防御敌机的子弹并击落尽可能多的敌机以获取更高的分数。注意拾取宝箱道具来获得强化。";
		t.wordWrap = true;
		t.x = 292;
		t.y = 498;
		return t;
	...
	function enemyPlane() {
		...
		this.states = [
			...
			new eui.State ("rspin",
				[
					new eui.SetProperty("_Image1","source","sheet_json#plane4spin")
				])
			,
			new eui.State ("lspin",
				[
					new eui.SetProperty("_Image1","source","sheet_json#plane4spin2")
				])
		];
	}
	...
	function extremePlane() {
		...
		this.states = [
			...
			new eui.State ("rspin",
				[
					new eui.SetProperty("_Image1","source","sheet_json#plane3spin")
				])
			,
			new eui.State ("lspin",
				[
					new eui.SetProperty("_Image1","source","sheet_json#plane3spin2")
				])
		];
	}
